...
class NewUserGreeting(GridLayout):  # TODO: create window collection and move the class from this file?
    def __init__(self, quit_callback, **kwargs):
        ...
        self._user = GameUser(name="Leo")
        self.cols = 1
        self.size_hint = (0.7, 0.8)
        self.pos_hint = {"center_x": 0.5, "center_y": 0.5}
        self.add_widget(Image(source="images/ranmoi3.png"))
        self.label = Label(
            text="Tên người chơi ",
            font_size=40,
            color="#00FFCE",
        ...
        self.add_widget(self.label)  # Thêm nhãn trước
        self.add_widget(self.name_input)  # Sau đó thêm ô nhập liệu
